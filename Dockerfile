...
&& apt-key update && apt-get update && apt-get install -y --no-install-recommends libsm6 libice6 libxext6 libxrender1 libfontconfig1 libx11-xcb-dev build-essential clang-5.0 clang-tidy-5.0 libXrender1 libsm6 libfreetype6 libglib2.0-0 libglu1-mesa-dev \
